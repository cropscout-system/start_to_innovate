...
from hybrid_approach import ObstacleAvoidanceController
...
def simulate_forest_scenario():
    ...
    # Создаём контроллер
    controller = ObstacleAvoidanceController(initial_altitude=drone_altitude)
    ...
    for iteration in range(simulation_iterations):
        ...
        command = controller.obstacle_avoidance(
